...
interface AddCustomerProductModalProps {
  isOpen: boolean;
  onClose: () => void;
  onProductAdded: () => void;
  supplierId: string;
...
export const AddCustomerProductModal = ({
  isOpen,
  onClose,
  onProductAdded,
  supplierId,
}: AddCustomerProductModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>Add New Customer Product</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <VStack spacing={6}>
